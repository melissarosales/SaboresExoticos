...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["feature-maintainance-image-maintainance-image-module"], {
  ...
  /***/
  function srcAppFeatureMaintainanceImageMaintainanceImageComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MaintainanceImageComponent", function () {
      return MaintainanceImageComponent;
    });
    /* harmony import */
    ...
    var _shared_modal_modal_add_image_modal_add_image_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! @shared/modal/modal-add-image/modal-add-image.component */
    "./src/app/shared/modal/modal-add-image/modal-add-image.component.ts");
    /* harmony import */
    ...
    var MaintainanceImageComponent = /*#__PURE__*/function () {
      function MaintainanceImageComponent(dialog) {
        _classCallCheck(this, MaintainanceImageComponent);

        this.dialog = dialog;
        this.unsubscribe$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
      }

      _createClass(MaintainanceImageComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "addNewImage",
        value: function addNewImage(data) {
          var dialogRef = this.dialog.open(_shared_modal_modal_add_image_modal_add_image_component__WEBPACK_IMPORTED_MODULE_3__["ModalAddImageComponent"], {
            data: data,
            minWidth: '33vw',
            maxWidth: '55vw',
            minHeight: '37vh',
          ...
          var sub = dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.unsubscribe$)).subscribe(function () {
            sub.unsubscribe();
          });
        }
      }]);
    ...
    MaintainanceImageComponent.ɵfac = function MaintainanceImageComponent_Factory(t) {
      return new (t || MaintainanceImageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__["MatDialog"]));
    };

    MaintainanceImageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: MaintainanceImageComponent,
      selectors: [["app-maintainance-image"]],
      decls: 50,
      vars: 0,
      consts: [[1, "wrapper"], [1, "container"], [1, "row", "mb-2"], ["type", "submit", 1, "btn", "btn-primary", "ml-auto", 3, "click"], [1, "table-responsive"], [1, "table", "table-bordered", 2, "margin", "auto", "width", "100% !important"], [1, "text-center"], [1, "btn", "btn-outline-danger"], ["href", "# ", "aria-hidden", "true ", 1, "fa", "fa-trash-o"]],
      template: function MaintainanceImageComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Mantenimiento de im\xE1genes");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function MaintainanceImageComponent_Template_button_click_6_listener() {
            return ctx.addNewImage("asda");
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MaintainanceImageComponent, [{
  ...
  /***/
  function srcAppFeatureMaintainanceImageMaintainanceImageModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "MaintainanceImageModule", function () {
      return MaintainanceImageModule;
    });
    /* harmony import */
    ...
    var _maintainance_image_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./maintainance-image.component */
    "./src/app/feature/maintainance-image/maintainance-image.component.ts");
    /* harmony import */
    ...
    var routes = [{
      path: '',
      component: _maintainance_image_component__WEBPACK_IMPORTED_MODULE_2__["MaintainanceImageComponent"]
    }];

    var MaintainanceImageModule = function MaintainanceImageModule() {
      _classCallCheck(this, MaintainanceImageModule);
    };

    MaintainanceImageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: MaintainanceImageModule
    });
    MaintainanceImageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function MaintainanceImageModule_Factory(t) {
        return new (t || MaintainanceImageModule)();
      },
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](MaintainanceImageModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](MaintainanceImageModule, [{
...
//# sourceMappingURL=feature-maintainance-image-maintainance-image-module-es5.js.map